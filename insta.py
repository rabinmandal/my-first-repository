# imports
import requests
from locker import own_post,recent_liked,self_info,user_info,user_likes,user_post,del_comment,list_comments,post_comments,targetted_post

# Credentials
app_access_token='----text me here----'
